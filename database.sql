...
INSERT [dbo].[customers] ([customer_id], [email], [name], [password], [phone], [register_date], [image], [address], [status], [gender], [admin]) VALUES (1, N'duy138p5@gmail.com', N'Nguyễn Nhã Thảo Duy', N'$2a$10$sWya0nwSZF.KTZA7tfSsauowRWPrZgis8oYeg5m2WQLENRc5Dwf4K', N'0987654321', CAST(N'2022-06-13' AS Date), N'img_01.jpg', N'Tiền Giang', 1, 1, 1)
INSERT [dbo].[customers] ([customer_id], [email], [name], [password], [phone], [register_date], [image], [address], [status], [gender], [admin]) VALUES (2, N'duyth4o@gmail.com', N'Cao Thành Lâm', N'$2a$10$93UmGQ3xLaxW1fGn9cmX0enf2MoS6ee69hdAsUl/FBImJllkswxX6', N'0987654321', CAST(N'2022-06-14' AS Date), N'img_02.jpg', N'Bến Tre', 1, 1, 0)
INSERT [dbo].[customers] ([customer_id], [email], [name], [password], [phone], [register_date], [image], [address], [status], [gender], [admin]) VALUES (3, N'dat@gmail.com', N'Nguyễn Thành Đạt', N'$2y$12$8tleNpHGtHScVZNXd1fKeu8dSIU4cbU.eWzgDGuXtMm/IBRVt/neu ', N'0987654321', CAST(N'2022-06-11' AS Date), N'img_03.jpg', N'Cà Mau', 1, 1, 0)
INSERT [dbo].[customers] ([customer_id], [email], [name], [password], [phone], [register_date], [image], [address], [status], [gender], [admin]) VALUES (4, N'lam02032001@gmail.com', N'Lê Dương Bảo Lâm', N'$2a$10$kbRH7BV5Y2ZfLAoyVETgG.7hIyxrc7I.tYhfMP7FR209c4sHL5aou', N'0987654322', CAST(N'2022-06-14' AS Date), N'img_04.jpg', N'Đà Nẵng', 1, 1, 0)
INSERT [dbo].[customers] ([customer_id], [email], [name], [password], [phone], [register_date], [image], [address], [status], [gender], [admin]) VALUES (6, N'dong@gmail.com', N'Đỗ Hoàng Dương', N'$2a$10$1XjOUZPlGmb/X2bkXhpQs.GIlFnIa8pkjzYjO5FkJxS/wWWNgoESy', N'0987654320', CAST(N'2022-06-14' AS Date), N'img_05.jpg', N'Quãng Ngãi', 1, 0, 0)
INSERT [dbo].[customers] ([customer_id], [email], [name], [password], [phone], [register_date], [image], [address], [status], [gender], [admin]) VALUES (18, N'duyyudth@gmail.com', N'Phạm Anh Tuấn', N'$2a$10$wsmLWUAKMDyfkThGYn2LFufdFHuUu/XZIFL.wfEHoOTjI7.Te3AFa', N'0987632321', CAST(N'2022-06-11' AS Date), N'img_06.jpg', N'TP HCM', 1, 1, 0)
INSERT [dbo].[customers] ([customer_id], [email], [name], [password], [phone], [register_date], [image], [address], [status], [gender], [admin]) VALUES (23, N'th4oduy@gmail.com', N'Nguyễn Thị Thảo', N'$2a$10$B/c0oV21iQdekgJp9lNBPu2xeD5Fhzr1cKY24GXT3wm1nbdJFftMK', N'0983214321', CAST(N'2022-06-13' AS Date), N'img_07.jpg', N'Đồng Nai', 1, 1, 0)
INSERT [dbo].[customers] ([customer_id], [email], [name], [password], [phone], [register_date], [image], [address], [status], [gender], [admin]) VALUES (25, N'lamnhtpd03789@fpt.edu.vn', N'Nguyễn Thanh Lam', N'$2a$10$UkIPM2DZfP/i2ppMfWALCucZO6Hp05cW2xw.oU06/Rovt6cBKO3zu', N'0932454321', CAST(N'2022-06-14' AS Date), N'img_08.jpg', N'TP HCM', 1, 1, 0)
...
Bàn phím AKKO khi kết nối với MacOS: (Ctrl -> Control | Windows -> Command | Alt -> Option, Mojave OS trở lên sẽ điều chỉnh được thứ tự của các phím này)', 0, CAST(N'2022-06-12' AS Date), N'akko_3068_v2_2022_year_of_the_ox.jpg', N'AKKO 3068 v2 2022 Year of the Ox', 99, 0, 1950000)
